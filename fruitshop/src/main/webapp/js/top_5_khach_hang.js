		...
		if (xhr.readyState == 4 && xhr.status == 200) {
			...
			for (var i = 0; i < data.length; i++) {
				...
				<tr class="dong-du-lieu">
					...
					<td>
						<div class="chi-tiet-du-lieu">
							<span style="font-weight: 600;">${data[i].ten}</span>
						</div>
					</td>
					<td>
						<div class="chi-tiet-du-lieu">				
					...
					<td>
						<div class="chi-tiet-du-lieu">
							<span ${choose == 0 ? 'class="tien-format"' : ''} style="color: #ff2626; font-weight: 600;">${(choose == 0) ? (data[i].tongChiTieu) : (data[i].soLuongDaMua)}</span>
						</div>
					</td>
				</tr>
				`
